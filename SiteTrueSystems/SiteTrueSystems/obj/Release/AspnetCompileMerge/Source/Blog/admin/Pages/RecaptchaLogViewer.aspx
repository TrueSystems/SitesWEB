<%@ Page Language="C#" AutoEventWireup="true" Inherits="admin_Pages_RecaptchaLogViewer" EnableViewState="true" Codebehind="RecaptchaLogViewer.aspx.cs" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #phDetails {padding:10px; height: 390px; overflow: auto; overflow-x: auto}
...
<body scroll="no" onkeypress="ESCclose(event)">
    ...
    <div id="title">
      <label>Recaptcha Log</label>
    </div>
    
    <div id="phDetails">
    <ul>
      <li><b>Attempts:</b> The number of tries before a successful captcha submission. This includes the successful attempt.</li>
      <li><b>Time to Post:</b> The time (in seconds) from the original page load to when the user has sucessfully posted a comment.</li>
      <li><b>Time to Solve:</b> The time to solve the captcha from either the original page load, or the last unsuccessful captcha attempt.</li>
    </ul>
      <asp:GridView 
            runat="server" 
            ID="RecaptchaLog"
          ...
          <Columns>
            ...
            <asp:BoundField DataField="Date" HeaderText="<%$ Resources:labels, date %>" ItemStyle-HorizontalAlign="Center" HtmlEncode="false" DataFormatString="{0:dd-MMM-yyyy HH:mm}" />
            ...
            <asp:BoundField DataField="CommentTime" HeaderText="Time to Post" HtmlEncode="false"  ItemStyle-HorizontalAlign="Center" DataFormatString="{0:N1}" />
            <asp:BoundField DataField="RecaptchaTime" HeaderText="Time to Solve" HtmlEncode="false"  ItemStyle-HorizontalAlign="Center" DataFormatString="{0:N1}" />
          </Columns>
          </asp:GridView>
          </div>
