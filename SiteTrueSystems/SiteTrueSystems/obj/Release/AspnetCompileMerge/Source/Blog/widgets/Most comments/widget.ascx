<%@ Control Language="C#" AutoEventWireup="true" Inherits="widgets_Most_comments_widget" Codebehind="widget.ascx.cs" %>
  ...
  <ItemTemplate>
    <tr class="vcard">
      ...
      <td style="vertical-align :top; padding-left: 10px; line-height:17px">
        ...
        <span class="adr">
          <span class="country-name"><asp:Literal runat="server" ID="litCountry" /></span>
        </span>
      </td>
    </tr>
  </ItemTemplate>
