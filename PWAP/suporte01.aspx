...
<title>PWAP - Automação da força de vendas | Contato</title>
	...
	<div id="wrapper">
		...
		<nav role="navigation">
			<ul id="nav">
				...
				<li class="nav"><a class="nav" href="#" title="Fale Conosco">Fale Conosco</a></li>
			</ul>
		...
		<div id="container">
			<section id="contact">
				<div class="blue-strip">
					<h2 class="title-strip">Contato</h2>
				</div>
				<h3 class="contact">Para comprar o <strong>PWAP - Automação da Força de Vendas</strong>, tirar dúvidas ou fazer sugestões, você pode telefonar para <strong>(21) 3084-0084</strong> ou <strong>(21) 2025-1057</strong>.<br>
				Ou preencher nosso formulário de contato.</h3>
				<script type="text/javascript" src="http://form.jotformz.com/jsform/22745543218656"></script>
			</section>
