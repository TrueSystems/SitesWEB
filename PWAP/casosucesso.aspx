	...
	<div id="wrapper">
		...
		<nav role="navigation">
			<ul id="nav">
				...
				<li class="nav"><a class="nav" href="#" title="Casos de Sucesso">Cases</a></li>
		...
		<div id="container">
			<section id="cases">
				<div class="blue-strip">
					<h2 class="title-strip">Casos de Sucesso</h2>
				</div>
				<hgroup class="centered">
					<a href="casoalfaparf.aspx"><img class="space-right" src="images/alfaparf.gif" alt="Marca da Alfaparf Milano" /></a>
					<a href="casoecopaper.aspx"><img src="images/melhoramentos-ecopaper.png" alt="Marca da Melhoramentos Papéis e da Ecopaper"/></a>
				</hgroup>
			</section>
			...
			<section id="prizes">
				<div class="blue-strip">
					<h2 class="title-strip">Prêmios</h2>
				</div>
				<hgroup class="centered">
					<a href="frmpremio.aspx"><img class="space-right" src="images/ctia.jpg" alt="CTIA Wireless 2006" /></a>
					<a href="frmpremio02.aspx"><img src="images/rioinfo2006.gif" alt="Prêmio Rio Info 2006" /></a>
				</hgroup>
			</section>
		...
		<footer>
			<div class="footer-links">
				<ul>
					...
					<li><a href="#" title="Casos de Sucesso">Cases</a></li>
